...
async function bootstrap() {
  ...
  const options = new DocumentBuilder()
    ...
    .addServer('http://0.0.0.0:3093', 'Local Server', { 'clientToken': { default: 'GPArE2mR+4yu37oxT/HMBvifTgDViU7164H93TtInNY', description: 'Client Token' } })
    .addServer('http://169.51.198.68:3093', 'Test  Server', { 'clientToken': { default: 'GPArE2mR+4yu37oxT/HMBvifTgDViU7164H93TtInNY', description: 'Client Token' } })
