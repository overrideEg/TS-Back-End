...
__decorate([
    ...
    __metadata("design:paramtypes", [stage_model_1.Stage]),
    __metadata("design:returntype", Promise)
], StageController.prototype, "saveStage", null);
__decorate([
    (0, common_1.Get)('/'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], StageController.prototype, "getAllStages", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], StageController.prototype, "findOne", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Put)(':id'),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, stage_model_1.Stage]),
    __metadata("design:returntype", Promise)
], StageController.prototype, "updateStage", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], StageController.prototype, "deleteStage", null);
StageController = __decorate([
    (0, swagger_1.ApiTags)('Stage'),
